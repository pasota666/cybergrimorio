...
Cuando arranca, su objetivo es comprobar que todo responde bien (**POST**) y después carga el **sistema operativo** buscando en los discos duros un sector llamado **MBR (Master Boot Record)** y le pasa el control.
