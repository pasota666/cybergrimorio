...
La justificación para esta atrocidad de web es la de disponer de una serie de notas on-line sobre tareas que tiendo a documentar una y otra vez y que después, suelo olvidar.
...
- **Entorno de ventanas**: KDE Plasma.
- **Navegador**: Brave.
- **Correo**: Thunderbird.
- **Editor**: VSCode.
- **IDE**: VSCode / Qt Creator.
- **Desarrollo**: C++, Qt, PHP, Shell, Gemix, Python.